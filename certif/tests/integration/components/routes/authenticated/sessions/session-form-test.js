...
module('Integration | Component | routes/authenticated/sessions | session-form', function() {

  module('When it creates a session', function(hooks) {
  ...
  module('When it updates a session', function(hooks) {
    setupRenderingTest(hooks);
    let session;
