...
<template>
  <PixFilterBanner
    ...
    @details={{t "pages.missions.mission.table.result.filters.learners-count" count=@controller.learnersCount}}
  ...
  <ResultTable @missionLearners={{@controller.model.missionLearners}} @mission={{@controller.model.mission.mission}} />
</template>
