...
module('Integration | Component | Campaign::Charts::ParticipantsByStatus', function (hooks) {
  ...
  test('it should display status for assessment campaign', async function (assert) {
    ...
    await render(
      hbs`<Campaign::Charts::ParticipantsByStatus @participantCountByStatus={{participantCountByStatus}} @isTypeAssessment={{true}} />`
    );
  ...
  test('it should display status for profile collection campaign', async function (assert) {
    ...
    await render(
      hbs`<Campaign::Charts::ParticipantsByStatus @participantCountByStatus={{participantCountByStatus}} @isTypeAssessment={{false}} />`
    );
