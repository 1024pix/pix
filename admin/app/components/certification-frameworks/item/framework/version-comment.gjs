...
export default class VersionComment extends Component {
  ...
  async saveComments() {
    try {
      ...
      this.pixToast.sendSuccessNotification({
        message: this.intl.t(
          'components.certification-frameworks.frameworks.version-detail-modal.comment-save-success',
        ),
      });
    } catch {
      ...
      this.pixToast.sendErrorNotification({
        message: this.intl.t(
          'components.certification-frameworks.frameworks.version-detail-modal.comment-save-error',
        ),
      });
    }
  }
  ...
  <template>
    <h2 class="certification-version-detail-modal__subtitle">{{t
        "components.certification-frameworks.frameworks.version-detail-modal.comment"
      }}</h2>
