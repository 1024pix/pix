          ...
          <dl>
            ...
            <dd>
              <PixTag @color={{get STATUS_COLORS @status}}>
                {{t (concat "components.certification-frameworks.certification-framework.history.statuses." @status)}}
              </PixTag>
            </dd>
            ...
            {{#if @version.startDate}}
              ...
              <dt>{{t
                  "components.certification-frameworks.certification-framework.version-detail-modal.start-date"
                }}</dt>
            ...
            {{#if @version.expirationDate}}
              <PixIcon @name="calendar" @ariaHidden={{true}} />
              <dt>{{t
                  "components.certification-frameworks.certification-framework.version-detail-modal.expiration-date"
                }}</dt>
              <dd>{{formatDate @version.expirationDate}}</dd>
            {{/if}}

            <PixIcon @name="flag" @ariaHidden={{true}} />
            <dt>{{t "components.certification-frameworks.certification-framework.version-detail-modal.locales"}}</dt>
            <dd>
            ...
            <dt>{{t
                "components.certification-frameworks.certification-framework.version-detail-modal.assessment-duration"
              }}</dt>
            <dd>{{formatMinutes @version.assessmentDuration}}</dd>

            <PixIcon @name="helpSimple" @ariaHidden={{true}} />
            <dt>{{t
                "components.certification-frameworks.certification-framework.version-detail-modal.maximum-assessment-length"
              }}</dt>
            <dd>{{@version.maximumAssessmentLength}}</dd>

            <PixIcon @name="helpSimple" @ariaHidden={{true}} />
            <dt>{{t
                "components.certification-frameworks.certification-framework.version-detail-modal.minimum-answers-required"
              }}</dt>
