  ...
  module('#model', function (hooks) {
    ...
    module('queryParams', function () {
      ...
      module('when queryParams startDate is "2026-01-01"', function () {
        test('it should call store.query with a `startDate` filter', async function (assert) {
          // given
      ...
      module('when queryParams endDate is "2026-01-01"', function () {
        test('it should call store.query with a `endDate` filter', async function (assert) {
          // given
