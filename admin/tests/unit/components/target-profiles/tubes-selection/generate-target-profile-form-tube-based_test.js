...
module('Unit | Component | target-profiles/tubes-selection/generate-target-profile-form-tube-based', function (hooks) {
  setupTest(hooks);

  let component;

  hooks.beforeEach(function () {
    component = createComponent('component:target-profiles/tubes-selection/generate-target-profile-form-tube-based', {
      frameworks: [
        { name: 'Pix', id: 'id1' },
