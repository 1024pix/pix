...
module('Unit | Component | authenticated/target-profiles/tubes-selection/tubes-selection-tube', function (hooks) {
  setupTest(hooks);

  let component;

  hooks.beforeEach(function () {
    component = createComponent('component:target-profiles/tubes-selection/tubes-selection-tube');
  });
