...
module('Unit | Component | target-profiles/new-tube-based/create-target-profile-form-tube-based', function (hooks) {
  setupTest(hooks);
  ...
  module('#frameworkOptions', function () {
    test('it should return a framework list as multiselect option data', function (assert) {
      component = createComponent('component:target-profiles/new-tube-based/create-target-profile-form-tube-based', {
        frameworks: [
