...
module('Integration | Component | <CertificationDetailsCompetence/>', function(hooks) {
  ...
  test('it renders', async function(assert) {
    ...
    // when
    await render(hbs`<CertificationDetailsCompetence @competence={{this.competence}} @rate=60 @onUpdateRate={{this.onUpdateRate}} />`);
  ...
  test('it should render jury values when these values are set', async function(assert) {
    // given
    this.setProperties({
      competence: competence('ok', 'ok', 'ko'),
      onUpdateRate: () => resolve(),
    });

    // when
    await render(hbs`<CertificationDetailsCompetence @competence={{this.competence}} @rate=60 @juryRate=70 @onUpdateRate={{this.onUpdateRate}} />`);
