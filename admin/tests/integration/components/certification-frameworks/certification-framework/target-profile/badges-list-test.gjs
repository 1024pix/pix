...
import BadgesList from 'pix-admin/components/certification-frameworks/certification-framework/target-profile/badges-list';
import { module, test } from 'qunit';

import setupIntlRenderingTest, { t } from '../../../../../helpers/setup-intl-rendering';

module(
  'Integration | Component | complementary-certifications/certification-framework/target-profile/badges-list',
  function (hooks) {
