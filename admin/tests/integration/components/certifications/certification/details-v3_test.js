...
module('Integration | Component | Certifications | certification > details v3', function (hooks) {
  ...
  module('#display', function () {
    ...
    test('it should display links to challenge info', async function (assert) {
      // given
      const store = this.owner.lookup('service:store');
      this.model = store.createRecord('v3-certification-course-details-for-administration', {
    ...
    test('it should display the table with every questions asked during certification', async function (assert) {
      // given
      const store = this.owner.lookup('service:store');
      this.model = store.createRecord('v3-certification-course-details-for-administration', {
