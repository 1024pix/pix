...
module('Integration | Component | TargetProfiles:TubesSelection::TubesSelectionTube', function (hooks) {
  ...
  test('it should disable level select if tube is not selected', async function (assert) {
    ...
    // when
    await render(
      hbs`<TargetProfiles::TubesSelection::TubesSelectionTube @competence={{this.competence}}
