...
module('Integration | Component | Module | QCU', function (hooks) {
  ...
  test('should display a QCU', async function (assert) {
    ...
    this.set('question', qcuElement);
    this.set('submitAnswer', givenSubmitAnswerStub);
    const screen = await render(hbs`<Module::Qcu @question={{this.question}} @submitAnswer={{this.submitAnswer}} />`);
  ...
  test('should display an ok feedback when exists', async function (assert) {
    ...
    const screen = await render(
      hbs`<Module::Qcu @question={{this.question}} @submitAnswer={{this.submitAnswer}} @correction={{this.correctionResponse}} />`,
    );
