...
import ChallengeLiveAlert from 'mon-pix/components/assessments/challenge-live-alert';
import { module, test } from 'qunit';
import sinon from 'sinon';

import setupIntlRenderingTest from '../../../helpers/setup-intl-rendering';

module('Integration | Component | Assessments | challenge-live-alert', function (hooks) {
  ...
  test('it displays challenge live alert', async function (assert) {
    ...
    // when
    const screen = await render(<template><ChallengeLiveAlert @assessment={{assessment}} @message={{message}} /></template>);
