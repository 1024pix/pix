...
module('Integration | Component | circle-chart', function (hooks) {
  ...
  module('Component rendering', function () {
    test('should render component', async function (assert) {
      ...
      // then
      assert.dom(this.element.querySelector('.circle-chart')).exists();
    });
    ...
    test('should display the circle with given color', async function (assert) {
      ...
      // then
      assert.dom(this.element.querySelector('.circle--slice').getAttribute('class')).hasText('circle--green');
    });
    ...
    test('should display the circle with given stroke width', async function (assert) {
      ...
      // then
      assert.dom(this.element.querySelector('.circle').getAttribute('class')).hasText('circle--thick');
      assert.dom(this.element.querySelector('.circle--slice').getAttribute('class')).hasText('circle--thick');
    });
    ...
    test('should display the chart with given width and height', async function (assert) {
      ...
      // then
      assert
        .dom(this.element.querySelector('.circle-chart__content').getAttribute('class'))
        .hasText('circle-chart__content--big');
    });
  });
});
