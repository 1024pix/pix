...
module('Integration | Component | challenge actions', function (hooks) {
  ...
  test('renders', async function (assert) {
    ...
    assert.dom(find('.challenge-actions__group')).exists();
  });
  ...
  module('Challenge has timed out', function () {
    test('should only display "continue" button', async function (assert) {
      ...
      // then
      assert.dom(find('.challenge-actions__action-validated')).doesNotExist();
      assert.dom(find('.challenge-actions__action-skip')).doesNotExist();
