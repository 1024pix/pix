  ...
  module('When there are eligible complementary certifications', function () {
    module('When there is only one eligible complementary certification', function () {
      test(`renders the complementary certification eligibility special message and picture`, async function (assert) {
        ...
        // when
        const screen = await render(
          hbs`<CertificationBanners::CongratulationsCertificationBanner @eligibleComplementaryCertifications={{this.eligibleComplementaryCertifications}} @complementaryCertifications={{this.certificationEligibility.complementaryCertifications}} @fullName={{this.fullName}} @closeBanner={{this.closeBanner}}/>`,
        );
