...
describe('Acceptance | AccountRecoveryAfterLeavingScoRoute', function() {
  ...
  context('when account recovery is enabled', () => {
    ...
    context('when submitting information form with valid data', () => {
      ...
      it('should hide student information form and show recover account confirmation step', async function() {
        ...
        // then
        expect(contains(this.intl.t('pages.account-recovery-after-leaving-sco.student-information.title'))).to.not.exist;
        expect(contains(this.intl.t('pages.account-recovery-after-leaving-sco.confirmation-step.good-news', { firstName }))).to.exist;
      });
    ...
    context('when submitting information form with invalid data', () => {
      ...
      it('should show a not found error', async function() {
        ...
        // then
        expect(contains(this.intl.t('pages.account-recovery-after-leaving-sco.student-information.title'))).to.exist;
        expect(contains(this.intl.t('pages.account-recovery-after-leaving-sco.student-information.errors.not-found'))).to.exist;
      });
    });
    ...
    context('when two students used same account', function() {
      ...
      it('should redirect to account recovery conflict page', async function() {
        ...
        // then
        expect(contains(this.intl.t('pages.account-recovery-after-leaving-sco.conflict.found-you-but', { firstName }))).to.exist;
        expect(contains(this.intl.t('pages.account-recovery-after-leaving-sco.student-information.title'))).to.not.exist;
      });
    });
    ...
    context('when confirm student information', () => {
      ...
      context('click on "Cancel" button', () => {
        ...
        it('should return to student information form', async function() {
          ...
          // when
          await clickByLabel(this.intl.t('pages.account-recovery-after-leaving-sco.backup-email-confirmation.form.actions.cancel'));
