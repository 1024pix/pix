    ...
    context('when confirm student information', () => {
      ...
      context('click on "Confirm" button', () => {
        ...
        it('should show email sent confirmation when user has supplied an email and submitted', async function() {
          ...
          // when
          await fillInByLabel(this.intl.t('pages.recover-account-after-leaving-sco.backup-email-confirmation.form.email'), newEmail);
          ...
          expect(contains(this.intl.t('pages.recover-account-after-leaving-sco.send-email-confirmation.title'))).to.exist;
