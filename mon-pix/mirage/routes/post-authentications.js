...
const createdUserAuthentication = {
  data: {
    type: 'authentication',
    attributes: {
      'user-id': 4,
      token: 'aaa.'+btoa('{"user_id":4,"source":"pix","iat":1545321469,"exp":4702193958}')+'.bbb'
    },
    id: 4
  }
};
...
export default function(schema, request) {
  ...
  if (email === 'joe@acme.com') return createdUserAuthentication;
