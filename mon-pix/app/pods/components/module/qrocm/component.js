...
export default class ModuleQrocm extends ModuleQuestion {
  @tracked selectedValues;

  get canValidateQuestion() {
    return this.question.proposals
  ...
  get formattedProposals() {
    return this.question.proposals.map((proposal) => {
  ...
  get nbOfProposals() {
    return this.question.proposals.filter(({ type }) => type !== 'text').length;
  }
