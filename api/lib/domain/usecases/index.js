...
module.exports = injectDependencies({
  ...
  findCampaignParticipationsByAssessment: require('./find-campaign-participations-by-assessment'),
  ...
  findUserCampaignParticipations: require('./find-user-campaign-participations'),
