...
import CampaignProfilesCollectionExport from '../../infrastructure/serializers/csv/campaign-profiles-collection-export';
...
export default async function startWritingCampaignProfilesCollectionResultsToStream({
  userId,
  campaignId,
  writableStream,
  i18n,
