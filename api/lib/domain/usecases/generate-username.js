...
module.exports = async function generateUsername({
  ...
  await userReconciliationService.findMatchingSchoolingRegistrationIdForGivenOrganizationIdAndUser({ organizationId: campaign.organizationId, reconciliationInfo: user, schoolingRegistrationRepository, userRepository });
