...
import { sources } from '../models/ComplementaryCertificationCourseResult';

const { EXTERNAL: EXTERNAL, PIX: PIX } = sources;
...
export default ComplementaryCertificationCourseResultsForJuryCertificationWithExternal;
