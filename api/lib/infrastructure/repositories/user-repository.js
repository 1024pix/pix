...
module.exports = {
  ...
  create(domainUser) {
    const userToCreate = _.omit(domainUser, ['pixRoles', 'memberships', 'certificationCenterMemberships', 'pixScore', 'knowledgeElements', 'competenceEvaluationResults']);
  ...
  updateUser(domainUser) {
    const userToUpdate = _.omit(domainUser, ['pixRoles', 'memberships', 'certificationCenterMemberships', 'pixScore', 'knowledgeElements', 'competenceEvaluationResults']);
