...
module.exports = Joi.object({
  ...
  status: Joi.string().example('validated').valid(certificationStatus).required().description('validated: le candidat a obtenu sa certification. rejected: le candidat a eu sa certification rejetée. pending: le candidat a passé sa certification mais elle n\'est pas encore publiée'),
  ...
  certificationCenter: Joi.string().example('Collège Kort Colin').required().description('Nom du centre de certification'),
