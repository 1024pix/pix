...
module.exports = {
  ...
  serialize(campaignParticipationOverview, meta) {
    return new Serializer('campaign-participation-overview',
      {
        attributes: ['isShared', 'sharedAt', 'createdAt', 'organizationName', 'assessmentState', 'campaignCode', 'campaignTitle', 'campaignArchivedAt', 'masteryRate', 'validatedStagesCount', 'totalStagesCount'],
        meta,
