import @awsSdk/clientS3 from '@aws-sdk/client-s3';

const {
  getSignedUrl
} = @awsSdk/s3RequestPresigner;
...
import @awsSdk/libStorage from '@aws-sdk/lib-storage';
import @awsSdk/s3RequestPresigner from '@aws-sdk/s3-request-presigner';
