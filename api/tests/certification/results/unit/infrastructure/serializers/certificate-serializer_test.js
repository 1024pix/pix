...
describe('Unit | Serializer | JSONAPI | certificate-serializer', function () {
  describe('#serialize', function () {
    describe('when algorithm engine version is V2', function () {
    ...
    describe('when algorithm engine version is V3', function () {
      it('should serialize to JSON with included relationships', function () {
        // given
        const area1 = domainBuilder.buildArea({
          id: 'recAREA1',
        ...
        expect(serializedCertifications.data).to.deep.equal({
          ...
          type: 'certifications',
          attributes: {
            'algorithm-engine-version': 3,
            birthdate: '1992-06-12',
            birthplace: 'Paris',
            'certification-center': 'L’université du Pix',
