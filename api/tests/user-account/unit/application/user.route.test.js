...
import { userController } from '../../../../src/user-account/application/user.controller.js';
import { expect, HttpTestServer, sinon } from '../../../test-helper.js';

const routesUnderTest = userAccountRoutes[0];

describe('Unit | User-Account | Application | Route | User', function () {
