...
describe('Unit | Application | Organizations | organization-controller', function () {
  describe('#uploadSiecleOrFregataFile', function () {
    ...
    beforeEach(function () {
      ...
      sinon.stub(usecases, 'uploadFregataFile');
    ...
    it('should delete uploaded file', async function () {
      ...
      // when
      await scoOrganizationManagementController.uploadSiecleOrFregataFile(request, hFake, dependencies);
    ...
    it('should call the usecase uploadFregataFile to import organizationLearners csv', async function () {
      // given
      const userId = 1;
      request.auth = { credentials: { userId } };
      ...
      // then
      expect(usecases.uploadFregataFile).to.have.been.calledWithExactly({
        userId,
        organizationId,
        payload,
        i18n,
