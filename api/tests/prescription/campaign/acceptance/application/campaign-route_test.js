...
describe('Acceptance | API | Campaign Route', function () {
  ...
  describe('GET /api/campaigns/{campaignId}/tutorial-steps', function () {
    it('should return the tutorial steps informations', async function () {
      // given
      ...
      const options = {
        method: 'GET',
        url: `/api/campaigns/${campaign.id}/tutorial-steps`,
      };
