    ...
    context('in a rich context close to reality', function () {
      ...
      context('when there are multiple participants who shared their participation', function () {
        beforeEach(function () {
          ...
          const knowledgeElementsDataAlice = [
            {
              userId: aliceId,
              competenceId: 'recCompetenceA',
              skillId: 'recUrl1',
          ...
          const knowledgeElementsDataBob = [
            // Bob
            {
              userId: bobId,
              competenceId: 'recCompetenceA',
          ...
          const knowledgeElementsDataCharlie = [
            {
              userId: charlieId,
              competenceId: 'recCompetenceA',
              skillId: 'recUrl1',
          ...
          const knowledgeElementsDataDan = [
            // Dan
            {
              userId: danId,
              competenceId: 'recCompetenceA',
          ...
          const knowledgeElementsDataElo = [
            {
              userId: eloId,
              competenceId: 'recCompetenceA',
              skillId: 'recUrl1',
