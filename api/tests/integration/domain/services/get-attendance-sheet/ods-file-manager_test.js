...
describe('Integration | Services | get-attendance-sheet | ods-file-manager', () => {
  ...
  describe('getContentXml', () => {
    ...
    it('should return the content.xml from the ods file as a string', async () => {
      ...
      // when
      const result = await odsFileManager.getContentXml({ odsFilePath });
  ...
  describe('makeUpdatedOdsByContentXml', () => {
    ...
    it('should return the edited ods file as a buffer', async () => {
      ...
      // when
      const updatedOdsFileBuffer = await odsFileManager.makeUpdatedOdsByContentXml({ stringifiedXml: updatedStringifiedXml, odsFilePath });
      fs.writeFileSync(updatedOdsFilePath, updatedOdsFileBuffer);
      const result = await odsFileManager.getContentXml({ odsFilePath: updatedOdsFilePath });
