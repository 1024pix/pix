...
describe('Integration | UseCases | simulateFlashScoring', function () {
  ...
  beforeEach(function () {
    const learningContent = {
      ...
      challenges: [
        { id: 'challenge1', skillId: 'skill1', status: 'validé', alpha: 0.16, delta: -2, locales, instruction: '' },
        { id: 'challenge2', skillId: 'skill2', status: 'validé', alpha: 3, delta: 6, locales, instruction: '' },
        { id: 'challenge3', skillId: 'skill3', status: 'validé', alpha: 1.587, delta: 8.5, locales, instruction: '' },
        {
          id: 'challenge4',
          skillId: 'skill4',
          status: 'validé',
        ...
        { id: 'challenge5', skillId: 'skill5', status: 'validé', alpha: 3, delta: 1, locales, instruction: '' },
        { id: 'challenge6', skillId: 'skill6', status: 'archivé', alpha: 1.7, delta: -1, locales, instruction: '' },
        { id: 'challenge7', skillId: 'skill7', status: 'validé', alpha: 2.5, delta: 5, locales, instruction: '' },
        { id: 'challenge8', skillId: 'skill7', status: 'validé', locales, instruction: '' },
        { id: 'challenge9', skillId: 'skill7', status: 'périmé', alpha: 1.7, delta: -1, locales, instruction: '' },
      ],
    };
