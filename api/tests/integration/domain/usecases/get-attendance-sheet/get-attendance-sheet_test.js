...
describe('Integration | UseCases | getAttendanceSheet', () => {
  ...
  beforeEach(async () => {
    ...
    _.each([
      { lastName: 'Jackson', firstName: 'Michael', birthCity: 'Paris', birthdate: '2004-04-04', sessionId, externalId: 'ABC123', extraTimePercentage: 0.6 },
      { lastName: 'Jackson', firstName: 'Janet', birthCity: 'Milan', birthdate: '2005-12-05', sessionId, externalId: 'DEF456', extraTimePercentage: null },
      { lastName: 'Mercury', firstName: 'Freddy', birthCity: 'Barcelone', birthdate: '1925-06-28', sessionId, externalId: 'GHI789', extraTimePercentage: 1.5 },
      { lastName: 'Gallagher', firstName: 'Jack', birthCity: 'Londres', birthdate: '1980-08-10', sessionId, externalId: null, extraTimePercentage: 0.15 },
    ], (candidate) => {
