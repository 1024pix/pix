...
describe('Integration | UseCases | getAttendanceSheet', () => {
  ...
  beforeEach(async () => {
    ...
    _.each([
      { lastName: 'Jackson', firstName: 'Michael', birthCity: 'Paris', birthdate: '2004-04-04', sessionId, externalId: 'ABC123', extraTimePercentage: 10 },
      ...
      { lastName: 'Mercury', firstName: 'Freddy', birthCity: 'Barcelone', birthdate: '1925-06-28', sessionId, externalId: 'GHI789', extraTimePercentage: 5.5 },
      { lastName: 'Gallagher', firstName: 'Jack', birthCity: 'Londres', birthdate: '1980-08-10', sessionId, externalId: 'JKL123', extraTimePercentage: 125 },
    ], (candidate) => {
