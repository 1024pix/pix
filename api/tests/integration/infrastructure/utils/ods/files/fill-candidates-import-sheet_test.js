  ...
  context('Version 1.5', () => {
    ...
    beforeEach(async () => {
      ...
      _.each([
        ...
        { lastName: 'Jackson', firstName: 'Janet', sex: 'F', birthINSEECode: '2A004', birthPostalCode: null, birthCity: null, birthCountry: 'France', email: 'jaja@hotmail.fr', resultRecipientEmail: 'destinataire@gmail.com', birthdate: '2005-12-05', sessionId, externalId: 'DEF456', extraTimePercentage: null },
        ...
        { lastName: 'Gallagher', firstName: 'Jack', sex: 'M', birthINSEECode: '99132', birthPostalCode: null, birthCity: null, birthCountry: 'Angleterre', email: 'jack@d.it', resultRecipientEmail: 'destinataire@gmail.com', birthdate: '1980-08-10', sessionId, externalId: null, extraTimePercentage: 0.15 },
      ], (candidate) => {
