...
describe('Integration | Repository | tube-repository', function () {
  ...
  beforeEach(async function () {
    databaseBuilder.factory.learningContent.buildTube(tubeData0);
    databaseBuilder.factory.learningContent.buildTube(tubeData1);
    databaseBuilder.factory.learningContent.buildTube(tubeData2);
    databaseBuilder.factory.learningContent.buildSkill(skillActive0);
    databaseBuilder.factory.learningContent.buildSkill(skillPasActive1);
    databaseBuilder.factory.learningContent.buildSkill(skillActive2);
    databaseBuilder.factory.learningContent.buildSkill(skillPasActive3);
