...
describe('Integration | Repository | Certification-ls ', () => {
  ...
  describe('#getCertificationsResultsByOrganizationUAI', () => {
    ...
    it('should return validated certification results for a given UAI', async () => {
      ...
      const certificationResults = await certificationLsRepository.getCertificationsResultsByOrganizationUAI(uai);
    ...
    it('should return rejected certification results for a given UAI', async () => {
      ...
      const [certificationResult] = await certificationLsRepository.getCertificationsResultsByOrganizationUAI(uai);
