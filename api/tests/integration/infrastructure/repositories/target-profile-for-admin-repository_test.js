    ...
    context('when target profile exists and is valid', function () {
      it('should return a new format target profile', async function () {
          ...
          tubes: [
            {
              ...
              practicalDescriptionFrFr: 'practicalDescFR1',
            },
            {
              id: 'recTube2',
              competenceId: 'recCompA',
              name: 'tubeName2',
              practicalTitleFrFr: 'practicalTitleFR2',
              practicalDescriptionFrFr: 'practicalDescFR2',
            },
            {
              id: 'recTube3',
              competenceId: 'recCompB',
              ...
              practicalDescriptionFrFr: 'practicalDescFR3',
            },
          ],
          skills: [
            {
        ...
        const tube1_themA_compA_areaA = {
          ...
          practicalDescription: 'practicalDescFR1',
          level: 4,
          mobile: false,
          tablet: true,
          thematicId: 'recThemA',
        ...
        const tube2_themB_compA_areaA = {
          ...
          practicalDescription: 'practicalDescFR2',
          level: 2,
          mobile: true,
          tablet: true,
          thematicId: 'recThemB',
        ...
        const tube3_themC_compB_areaA = {
          ...
          practicalDescription: 'practicalDescFR3',
          level: 8,
          mobile: false,
          tablet: false,
          thematicId: 'recThemC',
      ...
      it('should return target profile according to selected locale', async function () {
          ...
          tubes: [
            {
              ...
              practicalDescriptionFrFr: 'practicalDescFR1',
              practicalDescriptionEnUs: 'practicalDescEN1',
            },
          ],
          skills: [
            {
        ...
        const tube1_themA_compA_areaA = {
          ...
          practicalDescription: 'practicalDescEN1',
          level: 4,
          mobile: false,
          tablet: true,
          thematicId: 'recThemA',
