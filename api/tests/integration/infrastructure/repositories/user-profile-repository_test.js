...
const userProfileRepository = require('../../../../lib/infrastructure/repositories/user-profile-repository');
const KnowledgeElement = require('../../../../lib/domain/models/KnowledgeElement');
const UserProfile = require('../../../../lib/domain/models/UserProfile');

describe('Integration | Repository | User-profile', () => {
  ...
  describe('#get', () => {
    ...
    it('should return user profile', async () => {
      ...
      const expectedUserProfile = domainBuilder.buildUserProfile({
        userId,
        profileDate,
      ...
      // when
      const userProfile = await userProfileRepository.get({ id: userId, profileDate, targetProfileWithLearningContent });

      // then
      expect(userProfile).to.be.instanceOf(UserProfile);
      expect(userProfile).to.deep.equal(expectedUserProfile);
    });
