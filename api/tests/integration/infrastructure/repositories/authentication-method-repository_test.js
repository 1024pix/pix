...
describe('Integration | Repository | AuthenticationMethod', function () {
  ...
  describe('#updateCnavAuthenticationComplementByUserId', function () {
    context('When authentication method exists', function () {
      let cnavAuthenticationMethod;

      beforeEach(function () {
        const userId = databaseBuilder.factory.buildUser().id;
        cnavAuthenticationMethod = databaseBuilder.factory.buildAuthenticationMethod.withCnavAsIdentityProvider({
          id: 123,
          externalIdentifier: 'identifier',
          accessToken: 'to_be_updated',
          refreshToken: 'to_be_updated',
      ...
      it('should update the cnav authentication complement in database', async function () {
        // given
        const userId = cnavAuthenticationMethod.userId;
        const expiredDate = Date.now();
      ...
      it('should return the updated AuthenticationMethod', async function () {
        ...
        // then
        const expectedAuthenticationMethod = domainBuilder.buildAuthenticationMethod.withCnavAsIdentityProvider({
          id: 123,
          externalIdentifier: 'identifier',
          accessToken: 'new_access_token',
          refreshToken: 'new_refresh_token',
    ...
    context('When authentication method does not exist', function () {
      it('should throw a AuthenticationMethodNotFoundError', async function () {
        ...
        // when
        const error = await catchErr(authenticationMethodRepository.updateCnavAuthenticationComplementByUserId)({
          authenticationComplement,
          userId,
        });
