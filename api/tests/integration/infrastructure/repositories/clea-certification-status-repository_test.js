...
describe('Integration | Infrastructure | Repositories | clea-certification-status-repository', function() {

  describe('#getCleaCertificationStatus', function() {
    const certificationCourseRejectedCleaId = 1;
    const certificationCourseSuccessCleaId = 2;

    context('when there is no clea certification for a given certification id', function() {

      it('should return not_passed', async function() {
    ...
    context('when there is a clea certification for a given certification id', function() {
      ...
      it('when it\'s not acquired it should return rejected', async function() {
      ...
      it('when it\'s acquired it should return acquired', async function() {
