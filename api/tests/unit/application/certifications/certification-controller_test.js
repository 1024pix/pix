...
describe('Unit | Controller | certifications-controller', () => {
  ...
  describe('#findUserCertifications', function() {
    ...
    beforeEach(() => {
      ...
      sinon.stub(certificationRepository, 'findByUserId').resolves();
    });

    afterEach(() => {
      usecases.findCompletedUserCertifications.restore();
      certificationSerializer.serializeCertification.restore();
      certificationRepository.findByUserId.restore();
    });
