...
describe('Unit | Service | SolutionServiceQROCM-dep ', function() {
  ...
  context('One of the qroc is a select qroc', function() {
    [
      {
        when: 't3 is activated for the text qroc but not for the select one',
        output: ANSWER_PARTIALLY,
        answer: 'num1: googla\nnum2: yahou',
        solution: 'Google:\n- google\n- gogle\n- ggogle\nYahoo:\n- yahoo\n- yaoo\n',
        scoring: '1: acquix\n2: acquix',
        deactivations: { t1: true, t2: true },
        qrocBlocksTypes: { 'num1': 'select', 'num2': 'text' },
      },
      {
        when: 't1 is activated for the text qroc but not for the select one',
        output: ANSWER_PARTIALLY,
        answer: 'num1: goôgle\nnum2: Yàhoo',
        solution: 'Google:\n- google\n- gogle\n- ggogle\nYahoo:\n- yahoo\n- yaoo\n',
        scoring: '1: acquix\n2: acquix',
      ...
      {
        when: 't2 is activated for the text qroc but not for the select one',
        output: ANSWER_PARTIALLY,
        answer: 'num1: go!ogle\nnum2: ya!hoo',
        solution: 'Google:\n- google\n- gogle\n- ggogle\nYahoo:\n- yahoo\n- yaoo\n',
        scoring: '1: acquix\n2: acquix',
      ...
      {
        when: 't1,t2,t3 is activated for the text qroc but not for the select one',
        output: ANSWER_PARTIALLY,
        answer: 'num1: go! ogla\nnum2: ya! hôu',
        solution: 'Google:\n- google\n- gogle\n- ggogle\nYahoo:\n- yahoo\n- yaoo\n',
        scoring: '1: acquix\n2: acquix',
      ...
      it(testCase.when + ', should return ' + testCase.output + ' when answer is "' + testCase.answer + '" and solution is "' + escape(testCase.solution) + '"', function() {
        const solution = { value: testCase.solution, scoring: testCase.scoring, deactivations: testCase.deactivations, qrocBlocksTypes: testCase.qrocBlocksTypes };
        expect(service.match({ answerValue: testCase.answer, solution })).to.deep.equal(testCase.output);
      });
    });
  });
