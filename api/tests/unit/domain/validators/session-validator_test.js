...
describe('Unit | Domain | Validators | session-validator', function() {
  ...
  describe('#validateFilters', function() {
    ...
    context('when validating assignedToSelfOnly', function() {

      context('when assignedToSelfOnly not in submitted filters', function() {
      ...
      context('when assignedToSelfOnly is in submitted filters', function() {

        context('when assignedToSelfOnly is not an boolean', function() {
        ...
        context('when assignedToSelfOnly is a boolean string', function() {
        ...
        context('when assignedToSelfOnly is a boolean', function() {
          ...
          it('should set certificationOfficerId with currentUserId', async function() {
            // given
            const filters = {
    ...
    it('should unset assignToSelfOnly in filters', function() {
      // given
      const filters = {
        assignedToSelfOnly: true,
      };
