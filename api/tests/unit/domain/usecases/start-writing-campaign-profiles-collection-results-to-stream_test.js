...
describe('Unit | Domain | Use Cases | start-writing-campaign-profiles-collection-results-to-stream', () => {
  ...
  describe('#startWritingCampaignProfilesCollectionResultsToStream', () => {
    ...
    const certificationProfileService = { getCertificationProfiles: () => undefined };
    ...
    beforeEach(() => {
      ...
      sinon.stub(certificationProfileService, 'getCertificationProfiles').resolves([certificationProfile]);
