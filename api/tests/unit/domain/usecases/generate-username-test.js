...
describe('Unit | UseCase | generate-username', () => {
  ...
  let createUsernameBycertificationProfileServiceStub;
  let getCampaignStub;
  let user;
  ...
  beforeEach(() => {
    ...
    createUsernameBycertificationProfileServiceStub = sinon.stub(userReconciliationService,'createUsernameByUser');
  });
  ...
  context('When one schoolingRegistration matched on names', () => {
    ...
    it('should return schoolingRegistration ID found', async () => {
      ...
      createUsernameBycertificationProfileServiceStub.resolves(username);
