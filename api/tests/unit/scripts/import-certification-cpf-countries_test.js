  ...
  describe('#checkTransformUnicity', function() {
    ...
    describe('#when there are conflicts', function() {
      ...
      it('should throw an error', async function() {
        ...
        // eslint-disable-next-line no-console
        expect(console.error.getCall(0)).to.have.been.calledWithExactly('CONFLICT: 99140,99141 RÉPUBLIQUE DÉMOCRATIQUE ALLEMANDE,RÉPUBLIQUE DÉMOCRATIQUE ALLEMANDE');
        // eslint-disable-next-line no-console
        expect(console.error.getCall(1)).to.have.been.calledWithExactly('CONFLICT: 990000,990001 LA LA LA COMME DANS TOUT LES PAYS,COMME DANS TOUT LES PAYS LA LA LA');
      });
