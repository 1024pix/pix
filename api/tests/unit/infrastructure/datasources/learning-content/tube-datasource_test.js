...
describe('Unit | Infrastructure | Datasource | Learning Content | TubeDatasource', function () {
  ...
  describe('#findByThematicId', function () {
    it('should return an array of matching tube data objects', async function () {
      // given
      const rawTube1 = { id: 'RECORD_ID_RAW_TUBE_1', thematicId: 'thematicId1' };
      const rawTube2 = { id: 'RECORD_ID_RAW_TUBE_2', thematicId: 'thematicId1' };
      const rawTube3 = { id: 'RECORD_ID_RAW_TUBE_3', thematicId: 'thematicId2' };
