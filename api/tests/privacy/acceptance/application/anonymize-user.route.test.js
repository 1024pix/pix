...
const anonymizeUserEventHandlerSubscribers = [
  ...
  AnonymizeAuthenticationMethodsEventHandler,
  RemoveLegalDocumentByUserEventHandler,
  RevokeAllAnonymizedUserTokenEventHandler,
  ...
  AnonymizeLastUserApplicationConnectionsEventHandler,
  AnonymizeUserLoginEventHandler,
];
