...
describe('Integration | Deprecated | Repository | CertificationPointOfContact', function () {
  ...
  describe('#getPointOfContact', function () {
    it('returns a point of contact', async function () {
      ...
      const certificationPointOfContact = await certificationPointOfContactRepository.getPointOfContact({
        ...
        pixCertifTosStatus: domainBuilder.buildLegalDocumentStatus({ status: STATUS.ACCEPTED, acceptedAt: null }),
      });
      ...
      const expectedPointOfContact = {
        ...
        lang: userWithMembership.lang,
        pixCertifTermsOfServiceAccepted: true,
        pixCertifTermsOfServiceStatus: STATUS.ACCEPTED,
        pixCertifTermsOfServiceDocumentPath: null,
