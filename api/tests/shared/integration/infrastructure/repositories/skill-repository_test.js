...
describe('Integration | Repository | skill-repository', function () {
  ...
  beforeEach(async function () {
    databaseBuilder.factory.learningContent.buildSkill(skillData06_tubeCcompetenceB_actif);
    databaseBuilder.factory.learningContent.buildSkill(skillData03_tubeBcompetenceA_actif);
    databaseBuilder.factory.learningContent.buildSkill(skillData10_tubeDcompetenceB_archive);
    databaseBuilder.factory.learningContent.buildSkill(skillData00_tubeAcompetenceA_actif);
    databaseBuilder.factory.learningContent.buildSkill(skillData04_tubeBcompetenceA_archive);
    databaseBuilder.factory.learningContent.buildSkill(skillData01_tubeAcompetenceA_archive);
    databaseBuilder.factory.learningContent.buildSkill(skillData02_tubeAcompetenceA_perime);
    databaseBuilder.factory.learningContent.buildSkill(skillData11_tubeDcompetenceB_perime);
    databaseBuilder.factory.learningContent.buildSkill(skillData08_tubeCcompetenceB_perime);
    databaseBuilder.factory.learningContent.buildSkill(skillData05_tubeBcompetenceA_perime);
    databaseBuilder.factory.learningContent.buildSkill(skillData12_tubeEcompetenceC_perime);
