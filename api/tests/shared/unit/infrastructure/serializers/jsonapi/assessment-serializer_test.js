  ...
  describe('#serialize', function () {
    it('should convert a CertificationAssessment into JSON API data', function () {
      ...
      const challenge = domainBuilder.evaluation.buildChallengeToPlay({
        ...
        type: 'QCM',
        format: 'grand',
        illustrationAlt: 'Alternative text illu',
        illustrationUrl: 'http://example-image.com',
        locales: ['fr'],
        webComponentProps: null,
        webComponentTagName: 'tag name for web component',
      });
        ...
        included: [
          {
            ...
            attributes: {
              ...
              'auto-reply': false,
              'embed-height': 200,
              'embed-title': 'Titre embed',
              'embed-url': 'http://example.com',
              focused: true,
              format: 'grand',
              'illustration-alt': 'Alternative text illu',
              'illustration-url': 'http://example-image.com',
              instruction: 'Des instructions de base',
              locales: ['fr'],
              proposals: 'Une proposition',
              shuffled: true,
              timer: 123,
              type: 'QCM',
              'web-component-props': null,
              'web-component-tag-name': 'tag name for web component',
            },
          },
        ],
      };
