            ...
            thematics: [
              {
                ...
                tubes: [
                  ...
                  {
                    id: 'tubePixA1C1Th1Tu2',
                    name: '@tubePixA1C1Th1Tu2name',
                    description: 'tubePixA1C1Th1Tu2 description',
                    title: 'tubePixA1C1Th1Tu2 title',
                    practicalTitle: 'tubePixA1C1Th1Tu2 practicalTitle NOLANG',
                    practicalDescription: 'tubePixA1C1Th1Tu2 practicalDescription NOLANG',
                    practicalTitleFr: 'tubePixA1C1Th1Tu2 practicalTitle FR',
                    practicalDescriptionFr: 'tubePixA1C1Th1Tu2 practicalDescription FR',
                    practicalTitleEn: 'tubePixA1C1Th1Tu2 practicalTitle EN',
                    practicalDescriptionEn: 'tubePixA1C1Th1Tu2 practicalDescription EN',
                    skills: [
                      {
                        id: 'skillPixA1C1Th1Tu2S1',
                        status: 'actif',
                        hintFr: 'skillPixA1C1Th1Tu2S1 hint FR',
                        hintEn: 'skillPixA1C1Th1Tu2S1 hint EN',
                        hintStatus: 'Validé',
                        name: '@tubePixA1C1Th1Tu2name1',
                        pixValue: 1,
                        version: '1',
                        level: 1,
                        tutorials: [],
                      ...
                      {
                        id: 'skillPixA1C1Th1Tu2S3',
                        status: 'archivé',
                        name: '@tubePixA1C1Th1Tu2name3',
                        pixValue: 2,
                        version: '1',
                        level: 3,
                        tutorials: [],
                      ...
                      {
                        id: 'skillPixA1C1Th1Tu2S5',
                        status: 'actif',
                        name: '@tubePixA1C1Th1Tu2name5',
                        pixValue: 3,
                        version: '1',
                        level: 5,
                        tutorials: [],
                    ...
                    skills: [
                      {
                        ...
                        challenges: [
                          {
                            id: 'challengeCuisineA2C1Th1Tu1S1Ch1',
                            statut: 'validé',
                            langues: ['Franco Français'],
                            solution: 'challengeCuisineA2C1Th1Tu1S1Ch1 solution',
                            solutionToDisplay: 'challengeCuisineA2C1Th1Tu1S1Ch1 solutionToDisplay',
                            type: 'QROC',
                            focusable: false,
                            instruction: 'challengeCuisineA2C1Th1Tu1S1Ch1 instruction',
                            alternativeInstruction: 'challengeCuisineA2C1Th1Tu1S1Ch1 alternativeInstruction',
                            proposals: 'challengeCuisineA2C1Th1Tu1S1Ch1 proposals',
                            autoReply: false,
                            alpha: null,
                            delta: null,
                            timer: null,
                            illustrationUrl: 'challengeCuisineA2C1Th1Tu1S1Ch1 illustrationUrl',
                            illustrationAlt: 'challengeCuisineA2C1Th1Tu1S1Ch1 illustrationAlt',
                            attachments: ['challengeCuisineA2C1Th1Tu1S1Ch1 attachment1'],
                            embedUrl: 'challengeCuisineA2C1Th1Tu1S1Ch1 embedUrl',
                            embedTitle: 'challengeCuisineA2C1Th1Tu1S1Ch1 embedTitle',
                            embedHeight: 'challengeCuisineA2C1Th1Tu1S1Ch1 embedHeight',
                            format: 'challengeCuisineA2C1Th1Tu1S1Ch1 format',
                            responsive: 'Tablette',
                            genealogy: 'challengeCuisineA2C1Th1Tu1S1Ch1 genealogy',
                          },
                        ],
                      },
                    ],
