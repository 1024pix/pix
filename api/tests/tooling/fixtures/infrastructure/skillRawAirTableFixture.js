...
const DEFAULT_ID = 'recSK0X22abcdefgh',
  ...
  DEFAULT_HINT_FRFR = 'Can we geo-locate a rabbit on the ice floe?',
  DEFAULT_HINT_ENUS = 'Could we find the rabbit in the  ?',
  ...
  constructor(id) {
    super('Skill', id,{
      ...
      'fields': {
        ...
        'Nom': DEFAULT_NAME,
        'Indice': DEFAULT_HINT,
        'Indice fr-fr': DEFAULT_HINT_FRFR,
        'Indice en-us': DEFAULT_HINT_ENUS,
