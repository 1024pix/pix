...
const oidcProviderWellKnowResponse = {
  ...
  kerberos_endpoint: 'https://oidc.example.net/ea5ac20c-5076-4806-860a-b0aeb01645d4/kerberos',
...
async function createServerWithTestOidcProvider() {
  nock('https://oidc.example.net').get('/.well-known/openid-configuration').reply(200, oidcProviderWellKnowResponse);
