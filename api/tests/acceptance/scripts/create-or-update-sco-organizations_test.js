...
const { checkData, createOrUpdateOrganizations } = require('$root/scripts/create-or-update-sco-organizations');
const logoUrl = require('$root/scripts/default-sco-organization-logo-base64');
