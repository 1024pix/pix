  ...
  describe('GET /api/sessions/download-results/{token}', function() {
    ...
    context('when a valid token is given', () => {
      ...
      it('should return 200 HTTP status code', async () => {
        ...
        const certif2 = dbf.buildCertificationCourse({ sessionId: candidate2.sessionId, userId: candidate2.userId, lastName: candidate2.lastName, birthdate: candidate2.birthdate, createdAt: candidate1.createdAt });
