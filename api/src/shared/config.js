...
const configuration = (function () {
  const config = {
    ...
    cnav: {
      ...
      wellKnownUrl: process.env.CNAV_WELLKNOWN_URL,
    },
    cpf: {
      idClient: '03VML243',
    ...
    fwb: {
      ...
      wellKnownUrl: process.env.FWB_WELLKNOWN_URL,
    },
    google: {
    ...
    paysdelaloire: {
      ...
      wellKnownUrl: process.env.PAYSDELALOIRE_WELLKNOWN_URL,
    },
    pgBoss: {
    ...
    poleEmploi: {
      ...
      wellKnownUrl: process.env.POLE_EMPLOI_WELLKNOWN_URL,
    },
