    ...
    },
    {
      ...
      config: {
        ...
        notes: [
          ...
          '- Cette liste est paginée et filtrée selon des **states** qui peuvent avoir comme valeurs: ONGOING, ENDED et ARCHIVED',
        ],
        tags: ['api'],
      },
    },
...
export const campaignParticipationRoute = {
  name: 'prescription/campaign-participation/campaign-participation-api',
  register,
};
