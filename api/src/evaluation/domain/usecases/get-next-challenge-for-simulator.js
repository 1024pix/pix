...
const getNextChallengeForSimulator = function ({ simulationParameters, pickChallengeService, smartRandomService }) {
  ...
  stepsDetails.push(new SmartRandomStep(STEPS_NAMES.RANDOM_PICK, [challenge.skill]));

  return { challenge, stepsDetails };
};
