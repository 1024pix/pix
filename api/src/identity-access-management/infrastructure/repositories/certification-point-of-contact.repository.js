...
const getPointOfContact = async function ({
  ...
  const knexConn = DomainTransaction.getConnection();
  const certificationCenterMemberships = await _findNotDisabledCertificationCenterMemberships(knexConn, userId);
 ...
 */
async function _removeDisabledCertificationCenterAccesses({ knexConn, certificationPointOfContactDTO }) {
 ...
 */
async function _findNotDisabledCertificationCenterMemberships(knexConn, userId) {
