...
const getCurrentTargetProfilesHistoryWithBadgesByComplementaryCertificationId = async function ({
  ...
  return bluebird.mapSeries(currentTargetProfiles, async (targetProfile) => {
    const badges = await _getCurrentTargetProfileComplementaryCertificationBadges({ targetProfile });
...
async function _getCurrentTargetProfileComplementaryCertificationBadges({ targetProfile }) {
