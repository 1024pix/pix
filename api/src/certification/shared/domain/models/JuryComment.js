...
const AutoJuryCommentKeys = Object.freeze({
  ...
  REJECTED_DUE_TO_INSUFFICIENT_CORRECT_ANSWERS: 'REJECTED_DUE_TO_INSUFFICIENT_CORRECT_ANSWERS',
  REJECTED_DUE_TO_ZERO_PIX_SCORE: 'REJECTED_DUE_TO_ZERO_PIX_SCORE',
  CANCELLED_DUE_TO_LACK_OF_ANSWERS_FOR_TECHNICAL_REASON: 'CANCELLED_DUE_TO_LACK_OF_ANSWERS_FOR_TECHNICAL_REASON',
  LOWER_LEVEL_COMPLEMENTARY_CERTIFICATION_ACQUIRED: 'LOWER_LEVEL_COMPLEMENTARY_CERTIFICATION_ACQUIRED',
  REJECTED_EDU_NOT_ELIGIBLE: 'REJECTED_EDU_NOT_ELIGIBLE',
  REJECTED_PIX_PLUS_NOT_OBTAINED: 'REJECTED_PIX_PLUS_NOT_OBTAINED',
});
