...
module.exports = [
  { id:1, createdAt: moment().subtract(7, 'day').add(1, 'hour').toDate(), emitter: 'PIX-ALGO', commentForJury: 'Computed', status: 'validated', assessmentId: 1, level: 5, pixScore: 44 },
  { id:2, createdAt: new Date('2018-02-15T15:00:34Z'), emitter: 'PIX-ALGO', commentForJury: 'Computed', status: 'validated', assessmentId: 2, level: 2, pixScore: 23 },
  { id:3, createdAt: new Date('2018-02-15T15:03:18Z'), emitter: 'PIX-ALGO', commentForJury: 'Computed', status: 'validated', assessmentId: 3, level: 8, pixScore: 47 },
  { id:4, createdAt: new Date('2018-02-15T15:04:26Z'), emitter: 'PIX-ALGO', commentForJury: 'Computed', status: 'validated', assessmentId: 4, level: 4, pixScore: 34 },
  { id:5, createdAt: moment().subtract(1, 'day').toDate(), emitter: 'PIX-ALGO', commentForJury: 'Computed', status: 'validated', assessmentId: 5, level: 5, pixScore: 48 },
  { id:6, createdAt: new Date('2018-02-15T15:14:46Z'), emitter: 'PIX-ALGO', commentForJury: 'Computed', status: 'validated', assessmentId: 6, level: 0, pixScore: 157 },
  { id:7, createdAt: new Date('2018-04-27T10:11:02Z'), emitter: 'PIX-ALGO', commentForJury: 'Computed', status: 'validated', assessmentId: 7, level: -1, pixScore: 0 },
  {
    id: 9,
