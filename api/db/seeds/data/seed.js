...
function findSeedFileFromTableName = function (tableName) {
  return require('./data/' + directory + '/' + tableName + '.js')
};
...
function insertSeeds(knew, seedFilePath) {
