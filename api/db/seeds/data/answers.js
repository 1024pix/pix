module.exports =  [
  ...
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'recUgaNAIuu2ng0wR', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'recDEsKGRnH3yt5rG', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'recAprCTY1ixJ9ISA', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'rect9c6ahXsCjNn3e', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'recUuLdYdKOoOh2W2', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'rec6qcVEOmD3JNE8v', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'rec5WBXcLWAlMZlUI', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'recBYXbGG8m7AYIPs', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'rec1GYIaMxDz1eS51', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'recRVQCpdir9b0x1H', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'recn838PC4uEeQLcW', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'rec5o3fE3scuqxKnx', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'rec3CXFJOTMy9dUHu', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'rec39bDMnaVw3MyMR', elapsedTime: 0, resultDetails: 'null' },
  { value:'#ABAND#', result: 'aband', assessmentId: 7, challengeId: 'recjtrBI01FvZHYfz', elapsedTime: 0, resultDetails: 'null' },
];
