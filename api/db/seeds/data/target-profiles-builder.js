...
const skillIdsForSkillSet1 = [
  ...
  'recFwJlpllhWzuLom', 'rec0J9OXaAj5v7w3r', 'recUvHMSCCrhtSWS6', 'recdgeyLSVKUpyJF0',
  'recAuRue2poqxgQG2', 'recX7RyCsdNV2p168', 'recxtb5aLs6OAAKIg', 'recfLjzQKBD8Umdcx',
  'recetgnhc67yFnWbl', 'recPrXhP0X07OdHXe', 'reclDKLSXIsr4xoZp', 'recmLZ0CypLpsxm96',
  'rec2zofANqBsZdecI', 'reckgdGuUyHtQvhRo', 'reclY3njuk6EySJuU', 'rec5V9gp65a58nnco',
  'recKjdLuENEtJLx0f', 'recfSZlSomGI9PQjn', 'recg4t3r8Cs7RPKXY', 'recDl1yX3l2SWb9ju',
  'recZ6RUx2zcIaRAIC', 'recdwoJE9Po9zdf0A', 'receRbbt9Lb661wFB', 'rec71e3PSct2zLEMj',
  'recpyHTeNkGnFnqhZ', 'recHvlTH8v706UYvc', 'recagUd44RPEWti0X', 'recrvTvLTUXEcUIV1',
  'rec7QdcMIhYfmkgq9', 'recIkcTpbNZy9YetV', 'reciVlfNtTgkQJCHt', 'rec5LVAAMsUHYx5eD',
  'recvMdYj3tPrMa79u', 'recB1qZjFA0s2UsdU', 'recmMMVns3LEFkHeO', 'recfRe4luCCP8GoVA',
  'reckyBHOf8yIl2UGq',
];
...
const skillIdsForSkillSet2 = [
  ...
  'recuE3dO6Qjnfbu2y', 'recsPpUso9cY2u1I8', 'recH8iHKeJ5iws289', 'rec9uQTL8ZFm1rSTY',
...
const skillIdsForSkillSet4 = [
  ...
  'recLXE4vlQ5vcGsLP', 'reco16sNopoBMdhnQ', 'recgs5q5APUX7kcRp', 'recvo2KPsvK0fnIIN',
...
function targetProfilesBuilder({ databaseBuilder }) {
  ...
  _buildTargetProfilePixEduFormationInitiale(databaseBuilder);
  _buildTargetProfilePixEduFormationContinue(databaseBuilder);
}
