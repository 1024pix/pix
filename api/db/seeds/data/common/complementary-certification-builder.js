...
import { PRO_ORGANIZATION_ID, REAL_PIX_SUPER_ADMIN_ID } from './constants.js';
...
export {
  ...
  complementaryCertificationBuilder,
...
function _createComplementaryWithHasComplementaryReferential(databaseBuilder) {
  ...
  databaseBuilder.factory.buildBadge({
    ...
    imageUrl: 'https://assets.pix.org/badges/badge_pix-PIX_DROIT_silver%20copy.svg',
  ...
  databaseBuilder.factory.buildBadge({
    ...
    imageUrl: 'https://assets.pix.org/badges/badge_pix-PIX_DROIT_gold%20copy.svg',
...
function _createWithHasExternalJury(databaseBuilder) {
  ...
  databaseBuilder.factory.buildBadge({
    ...
    imageUrl: 'https://assets.pix.org/badges/Pix_plus_Edu-certif-confirme_PREMIER-DEGRE.svg',
  ...
  databaseBuilder.factory.buildComplementaryCertificationBadge({
    ...
    level: 1,
    imageUrl: 'https://assets.pix.org/badges/Pix_plus_Edu-certif-Autonome_PREMIER-DEGRE.svg',
  ...
  databaseBuilder.factory.buildBadge({
    ...
    imageUrl: 'https://assets.pix.org/badges/Pix_plus_Edu-Confirme-PREMIER-DEGRE.svg',
