...
async function _makeCandidatesComplementaryCertificationCertifiable(
  ...
  const campaignCode = _createCodeCampaign(frameworkName, complementaryCertificationId);
...
function _createCodeCampaign(frameworkName, complementaryCertificationId) {
